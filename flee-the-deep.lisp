...
(defun display-title-screen ()
  (let ((width (charms:window-dimensions charms:*standard-window*)))
    ...
    (charms:write-string-at-point charms:*standard-window* (format nil (centre-format-string width "w,a,s,d to move")) 0 5)
    (charms:write-string-at-point charms:*standard-window* (format nil (centre-format-string width "q to quit")) 0 6)
    (charms:write-string-at-point charms:*standard-window* (format nil (centre-format-string width "The exit (>) is at the bottom right")) 0 7)
    (charms:write-string-at-point charms:*standard-window* (format nil (centre-format-string width "Beware the beast")) 0 8)
